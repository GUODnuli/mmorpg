...
namespace GameServer.Services
{
    class MapService : Singleton<MapService>
    {
        ...
        private void OnMapEntitySync(NetConnection<NetSession> sender, MapEntitySyncRequest request)
        {
            ...
            Log.InfoFormat("OnMapEntitySync: Character ID: {0}, Character Name: {1}, Entity ID: {2}, Entity Event: {3}, Entity: {4}", character.Id, character.Info.Name, entitySync.EntityId, entitySync.Event, entitySync.Entity);
